...
'''
import datetime
from etfutils import etfDailyData, spyDailyData, diaDailyData
...
etfDailyData(filePrefix, outputDir)
spyDailyData(filePrefix, outputDir)
diaDailyData(filePrefix, outputDir)
